...
const usersCreate = query('CREATE TABLE IF NOT EXISTS `users` (\n' +
...
const storesCreate = query('CREATE TABLE IF NOT EXISTS `stores` (\n' +
  '  `id` INTEGER PRIMARY KEY AUTOINCREMENT,\n' +
...
const storeUsersCreate = query('CREATE TABLE IF NOT EXISTS `storeUsers` (\n' +
  '  `id` INTEGER PRIMARY KEY AUTOINCREMENT,\n' +
  '  `userId` INTEGER NOT NULL,\n' +
  '  `storeHash` TEXT NOT NULL,\n' +
  '  `isAdmin` INTEGER,\n' +
